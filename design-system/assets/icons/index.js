/* Babel OS icon set — path data copied verbatim from app/js/shell.js (window.BabelIcones).
   24x24 grid, fill:none, stroke:currentColor, stroke-width 1.8, round caps/joins. */
window.BABEL_ICON_PATHS = {
